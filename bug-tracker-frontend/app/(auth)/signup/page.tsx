      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-xl shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-none">
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link href="/login" className="font-medium text-slate-900 underline decoration-slate-300 underline-offset-2 hover:decoration-slate-900 dark:text-slate-100 dark:decoration-slate-600 dark:hover:decoration-slate-100">
              Sign in
            </Link>
          </p>
        </form>
